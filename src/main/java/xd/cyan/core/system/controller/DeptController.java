...
import xd.cyan.core.common.entity.DeptTree;
...
import xd.cyan.core.system.entity.Dept;
import xd.cyan.core.system.service.IDeptService;
...
public class DeptController {
    ...
    @GetMapping("tree")
    @ControllerEndpoint(exceptionMessage = "获取部门树失败")
    public CyanResponse getDeptTree(Dept dept) throws FebsException {
        List<DeptTree<Dept>> depts = this.deptService.findDepts(dept);
        return new CyanResponse().success().data(depts);
    }

    @PostMapping
    @RequiresPermissions("dept:add")
    @ControllerEndpoint(operation = "新增部门", exceptionMessage = "新增部门失败")
    public CyanResponse addDept(@Valid Dept dept) {
    ...
    public CyanResponse deleteDepts(@NotBlank(message = "{required}") @PathVariable String deptIds) throws FebsException {
    ...
    public CyanResponse updateDept(@Valid Dept dept) throws FebsException {
