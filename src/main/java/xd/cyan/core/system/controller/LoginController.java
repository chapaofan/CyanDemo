...
import xd.cyan.core.common.service.ValidateCodeService;
...
public class LoginController extends BaseController {
    ...
    public CyanResponse index(@NotBlank(message = "{required}") @PathVariable String username) {
        // 更新登录时间
