...
import xd.cyan.core.monitor.endpoint.FebsHttpTraceEndpoint;
import xd.cyan.core.monitor.entity.FebsHttpTrace;
...
public class FebsActuatorController {
    ...
    public CyanResponse httpTraces(String method, String url) {
