...
import xd.cyan.core.job.service.IJobLogService;
...
public class JobLogController extends BaseController {
    ...
    public CyanResponse jobLogList(QueryRequest request, JobLog log) {
    ...
    public CyanResponse deleteJobLog(@NotBlank(message = "{required}") @PathVariable String jobIds) {
