package xd.cyan.core.job.controller;
...
import xd.cyan.core.job.entity.Job;
import xd.cyan.core.job.service.IJobService;
...
public class JobController extends BaseController {
    ...
    public CyanResponse jobList(QueryRequest request, Job job) {
    ...
    public CyanResponse addJob(@Valid Job job) {
    ...
    public CyanResponse deleteJob(@NotBlank(message = "{required}") @PathVariable String jobIds) {
    ...
    public CyanResponse updateJob(@Valid Job job) {
    ...
    public CyanResponse runJob(@NotBlank(message = "{required}") @PathVariable String jobIds) {
    ...
    public CyanResponse pauseJob(@NotBlank(message = "{required}") @PathVariable String jobIds) {
    ...
    public CyanResponse resumeJob(@NotBlank(message = "{required}") @PathVariable String jobIds) {
